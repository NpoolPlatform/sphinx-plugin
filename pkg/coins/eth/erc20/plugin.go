...
func init() {
	...
	err := register.RegisteAbortFuncErr(sphinxplugin.CoinType_CoinTypeusdcerc20, eth.TxFailErr)
	if err != nil {
		panic(err)
	}

	err = register.RegisteAbortFuncErr(sphinxplugin.CoinType_CoinTypetusdcerc20, eth.TxFailErr)
	if err != nil {
		panic(err)
	}
}
